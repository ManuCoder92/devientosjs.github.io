...
saxo.push(new Producto (1,"Eastar","alto",350,20,30, `multimedia/easterAlto.jpg` )) // Link : https://www.amazon.es/Eastar-EB134-FBA-CA-Saxof%C3%B3n-alto/dp/B07HL8YNJH/ref=sr_1_7?crid=19THTKU8JB9VS&keywords=saxofon+alto&qid=1657877947&sprefix=%2Caps%2C675&sr=8-7
saxo.push(new Producto (2,"J. Michael AL500","alto",423,122,40,`multimedia/jMichael.jpg`)) // Link: https://www.amazon.es/J-Michael-AL500-Saxo-alto/dp/B001IY8XAQ/ref=sr_1_5?crid=19THTKU8JB9VS&keywords=saxofon+alto&qid=1657877947&sprefix=%2Caps%2C675&sr=8-5
saxo.push(new Producto (3,"BTER","alto",497,30,10,`multimedia/bter.jpg`) )   // link : https://www.amazon.es/profesional-Instrumentos-musicales-estudiantes-principiantes/dp/B09B162G7Q/ref=sr_1_1_sspa?crid=19THTKU8JB9VS&keywords=saxofon%2Balto&qid=1657877947&sprefix=%2Caps%2C675&sr=8-1-spons&spLa=ZW5jcnlwdGVkUXVhbGlmaWVyPUE1WjVQUTZNTzM5TjcmZW5jcnlwdGVkSWQ9QTA0OTY5OTkyTEVZNkVBUUlUTDVGJmVuY3J5cHRlZEFkSWQ9QTAxNzEwNzQySjdMSzA1TEFZM01PJndpZGdldE5hbWU9c3BfYXRmJmFjdGlvbj1jbGlja1JlZGlyZWN0JmRvTm90TG9nQ2xpY2s9dHJ1ZQ&th=1
saxo.push(new Producto (4,"sasuori","alto",249,10,33,`multimedia/sasuori.jpg`))   // link: https://www.amazon.es/Sasuori-Profesional-saxof%C3%B3n-Dominante-Limpieza/dp/B09L1FCLQ9/ref=sr_1_8?crid=19THTKU8JB9VS&keywords=saxofon%2Balto&qid=1657877947&sprefix=%2Caps%2C675&sr=8-8&th=1
...
clarinetes.push(new Producto (5, "Easter-Clarinete", "clarinete", 120, 0, 15, "../multimedia/easterbClarinete.jpg")) 
clarinetes.push(new Producto (6, "Summina", "Clarinete", 110, 20, 40, "../multimedia/summaniaClarinete.jpg" )) 
clarinetes.push(new Producto (7, "Montreux", "Clarinete",220,40,10, "../multimedia/montreuxClarinete.jpg"))  
clarinetes.push(new Producto (8, "Andoer", "Clarinete", 105,0,8,"../multimedia/andoerClarinete.jpg"))   

console.log (clarinetes)

const trompeta = []


trompeta.push (new Producto (9, "Vangoa", "trompeta", 190, 30, 14, "../multimedia/vangoaTrompeta.jpg"))
trompeta.push (new Producto (10, "Roy Benson", "trompeta", 373, 90, 12, "../multimedia/royBensonTrompeta.jpg"))
trompeta.push (new Producto (11, "Andoer-Trompeta", "trompeta", 150, 20, 20, "../multimedia/andoerTrompeta.jpg"))
trompeta.push (new Producto (12,"East Rock", "trompeta", 190, 30, 10, "../multimedia/eastRockTrompeta"))

console.log(trompeta)

// const contenedorCLarinetes = getElementById("idDivProductosClarinete")


// stockProductos.innerHTML ((producto) =>  {
...
//     })
// }else{
//     localStorage.setItem("carrito", JSON.stringify(carrito))      //#cd9515 dorado 1 #d69f0a
// }
...
// //agregar tarjetas a las paginas


// //local storage

const button1 = document.getElementById("buttonLibreria")

button1.addEventListener("click", () => {
    Swal.fire({
        title: 'Suscribite a nuestro Newsletter y recibe todas las novedades',
        input: 'email',
